...
As the GG developer team begins their research into Podman Desktop & AI Labs, they took notes that might be helpful for the rest of us to use. We'll use these notes, beginning with a brief review of podman to gain some basic knowledge before diving into the lab portion of this course.
