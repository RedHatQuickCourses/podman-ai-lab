...
== ABC Developers Research

As our ABC developer begins their reserach into Podman suite of of applications, they took notes that might be helpful for the rest of use. We'll use these notes, beginning with a brief review of podman to gain some basic knowledge before diving into the lab portion of this course.
